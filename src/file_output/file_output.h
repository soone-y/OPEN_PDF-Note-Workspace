...
bool ExportPdfPagePng(HWND owner, int pageIndex, PdfPngStyle style, bool includeAnnotations, int outWidthPx, int outHeightPx,
                      std::wstring* outSavedPath = nullptr);
...
// Note text exports.
bool ExportNotePlainText(HWND owner, const TextExportOptions& options, std::wstring* outSavedPath = nullptr);
bool ExportNoteMarkup(HWND owner, const NoteMarkupExportOptions& options, std::wstring* outSavedPath = nullptr);
