...
AI 向けドキュメント (For_AI.md, for_ai/*) に対して UTF-8 BOM (utf-8-sig) を付与します。
...
def main():
    target_files = [REPO_ROOT / "For_AI.md"] + list((REPO_ROOT / "for_ai").rglob("*"))
    count = 0
    ...
    print(f"\nSuccessfully applied UTF-8 BOM to {count} AI documentation files.")
